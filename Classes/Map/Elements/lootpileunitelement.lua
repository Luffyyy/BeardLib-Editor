...
function EditorLootPile:create_element(...)
	...
	self._element.values.carry_id = tweak_data.carry:get_carry_ids()[1]
...
function EditorLootPile:_build_panel()
	...
	self:ComboCtrl("carry_id", tweak_data.carry:get_carry_ids(), {help = "Select a carry_id to be created."})
