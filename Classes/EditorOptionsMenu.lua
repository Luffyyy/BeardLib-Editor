...
function Options:init()
	...
	visual:tickbox("SimplifiedElementHeaders", ClassClbk(self, "set_map_clbk"), O:GetValue("Map/SimplifiedElementHeaders"), {help = "Elements will only display their names, instead of name/id/class"})
