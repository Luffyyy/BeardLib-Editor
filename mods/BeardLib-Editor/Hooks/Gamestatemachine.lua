function GameStateMachine:init()
	...
	self:add_transition(editor, ingame_arrested, editor_func)
	self:add_transition(editor, ingame_electrified, editor_func)
	self:add_transition(editor, ingame_incapacitated, editor_func)
	...
	self:add_transition(editor, ingame_access_camera, editor_func)
	self:add_transition(editor, ingame_driving, editor_func)
	self:add_transition(editor, server_left, editor_func)
	self:add_transition(editor, gameoverscreen, editor_func)
	self:add_transition(editor, disconnected, editor_func)
	self:add_transition(editor, kicked, editor_func)
