...
function EditorSpecialObjective:_build_panel()
	...
	self:ComboBox("AccessFlagsPreset", ClassClbk(self, "apply_preset"), {"clear all", "select all"}, nil, {group = self._class_group, help = "Here you can quickly select or deselect all access flags"})
