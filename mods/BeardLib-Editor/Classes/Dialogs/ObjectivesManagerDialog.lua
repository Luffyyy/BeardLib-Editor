...
function ObjectivesManagerDialog:_Show()
    ...
    self:TextBox("Search", callback(BeardLibEditor.Utils, BeardLibEditor.Utils, "FilterList"), "", {override_parent = objectives, w = 300, control_slice = 0.8, lines = 1, highlight_color = false, position = function(item)
