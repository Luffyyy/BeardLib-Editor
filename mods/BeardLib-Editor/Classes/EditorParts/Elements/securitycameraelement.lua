...
function EditorSecurityCamera:_build_panel()
    ...
    self._elements_menu:Button({
 	...
 	self:_build_value_slider("yaw", {min = -180, max = 180}, "Specify camera yaw (degrees).")
 	self:_build_value_slider("pitch", {min = -90, max = 90}, "Specify camera pitch (degrees).")
 	self:_build_value_slider("fov", {min = 0, max = 180}, "Specify camera FOV (degrees).")
 	self:_build_value_slider("detection_range", {min = 0, floats = 0}, "Specify camera detection_range (meters).")
 	self:_build_value_slider("suspicion_range", {min = 0, floats = 0}, "Specify camera suspicion_range.")
 	self:_build_value_slider("detection_delay_min", {min = 0, floats = 0}, "Detection delay at zero distance.")
 	self:_build_value_slider("detection_delay_max", {min = 0, floats = 0}, "Detection delay at max distance.")
end
