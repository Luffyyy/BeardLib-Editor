...
function EditorSpecialObjective:_build_panel()
	...
	self:_build_value_checkbox("is_navigation_link", "Navigation link", "Navigation link")
	self:_build_value_checkbox("align_rotation", "Align rotation")
	self:_build_value_checkbox("align_position", "Align position")
	self:_build_value_checkbox("needs_pos_rsrv", "Reserve position", "Reserve position")
	...
	self:_build_value_checkbox("allow_followup_self", "Allow self-followup", "Allow self-followup")
